...
class ItemInventory extends StatelessWidget {
  const ItemInventory({super.key, this.productName, this.supplier, this.price, this.unit, this.stock});
                ...
                child: Row(
                  ...
                  Expanded(
                    ...
                    SizedBox(
                      ...
                      width: double.infinity, // Take full width of the column
                      child: ElevatedButton(
                        onPressed: () {
                          // Go to item deatails page
                        },
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Color(0xFF634795), // Button color
